...
class CryptoPairs:
    ...
    def __init__(self, config_path: str = "project/configuration/"):
        """
        Initialize CryptoPairs with configuration directory.
        
        Args:
            config_path: Path to configuration directory containing crypto_pairs.json
        """
        ...
        self.config_path = config_dir / "crypto_pairs.json"
        self._config = None
        self._load_config()
