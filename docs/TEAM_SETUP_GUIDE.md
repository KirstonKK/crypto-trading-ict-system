...
5. **Save Your Credentials**
   - Copy your **API Key** (e.g., `ABC123...`)
   - Copy your **API Secret** (e.g., `XYZ789...`)
...
If you're experiencing issues, run the automated diagnostic script from inside the container:

```bash
# Run diagnostic script
docker exec crypto-trading diagnose_blue_screen.sh
```
